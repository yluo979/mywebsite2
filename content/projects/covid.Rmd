...
```{r,eval=TRUE}
knitr::include_graphics(here::here("static",'img','projects', 'covid1.PNG'), error = FALSE)
```
...
```{r,eval=TRUE}
knitr::include_graphics(here::here("static",'img','projects', 'covid2.PNG'), error = FALSE)
```
...
```{r,eval=TRUE}
knitr::include_graphics(here::here("static",'img','projects', 'covid3.PNG'), error = FALSE)
```
